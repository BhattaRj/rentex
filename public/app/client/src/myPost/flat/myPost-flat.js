...
angular.module('myPost-flat').config(['$stateProvider', '$urlRouterProvider',
    function($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            .state('mypost-flats', {
                url: '/mypost-flats',
                templateUrl: 'app/client/src/myPost/flat/flat-list.tpl.html',
                controller: 'MyPostFlatListController',
            })
            .state('mypost-flat-new', {
                url: '/mypost-flat-new',
                templateUrl: 'app/client/src/myPost/flat/flat-new.tpl.html',
                controller: 'FlatNewController'
            })
            .state('mypost-flat-edit', {
                url: '/mypost-flat-edit/:flatId',
                templateUrl: 'app/client/src/myPost/flat/flat-edit.tpl.html',
