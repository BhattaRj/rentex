...
<!-- 	<link href="http://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet">
 -->	<link href="assets/plugins/jquery-ui/themes/base/minified/jquery-ui.min.css" rel="stylesheet" />
	...
	<!-- ================== Angular ================= -->
		...
		<script src="{{ url('app/admin/src/app.js')}}"></script>
		<script src="{{ url('app/admin/src/admin/admin.js')}}"></script>
		<script src="{{ url('app/admin/src/admin/facilities/admin-facilities.js')}}"></script>
...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					<li class="nav-profile">
						<div class="image">
							<a href="javascript:;"><img src="{{Auth::user()->profile_pic	}}" alt="" /></a>
						</div>
						<div class="info">
							{{Auth::user()->username}}
				...
				<ul class="nav">
					...
					<li><a href="#dashboard"><i class="fa fa-laptop"></i><span>Dashboard</span></a></li>
		...
		<!-- begin #content -->
		<div id="content" class="content" ng-app="app" ng-controller="appCtrl">
